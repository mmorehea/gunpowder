...
def train_until(max_iteration, gpu):
    ...
    request.add(VolumeTypes.RAW, input_shape)
    request.add(VolumeTypes.GT_LABELS, output_shape)
    request.add(VolumeTypes.GT_AFFINITIES, output_shape)
    if phase == 'euclid':
        request.add(VolumeTypes.LOSS_SCALE, output_shape)
